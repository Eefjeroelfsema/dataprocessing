...
def gdp(dataframe_gdp):
    ...
    n , bins, patches = plt.hist(dataframe_gdp, 50, normed=1, alpha=0.75)
    plt.xlabel('GDP')
    ...
    # make new histogram without outliers, histogram print niet als gepland, kan de fout niet vinden
    n , bins, patches = plt.hist(dataframe_gdpadjust, 50, normed=1, alpha=0.75)
    plt.xlabel('GDP')
    plt.ylabel('Probability')
